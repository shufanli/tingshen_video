...
if __name__ == '__main__':
    api = RequestApi(
        appid="4a2a0abf",
        secret_key="0d05fcfa72cf27509d1e190dc8f4d20c",
        upload_file_path=r"D:\PyProjects\pest_video\m3u8_mp3\p1.mp3",
        to_file=r"D:\PyProjects\pest_video\m3u8_mp3\p1.txt"
    )
    api.all_api_request()
